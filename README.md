...
REST API wrapper for the [whatsapp-web.js](https://github.com/gabrieldj1997/whatsapp-web.js) library, providing an easy-to-use interface to interact with the WhatsApp Web platform. 
